...
insert into usuario (id, nome, email, senha, data_cadastro) values (6, 'Débora Mendonça', 'inglezinho1+1@gmail.com', '123', utc_timestamp);
insert into usuario (id, nome, email, senha, data_cadastro) values (7, 'Carlos Lima', 'inglezinho1+2@gmail.com.com', '123', utc_timestamp);
