...
create table produto (id bigint not null auto_increment, ativo bit, descricao varchar(255), nome varchar(255), preco decimal(38,2), restaurante_id bigint, primary key (id)) engine=InnoDB;
